return { {
  ...
  keys = {
    ...
    { "<leader>gc",      function() require("telescope-extensions").find_branch_files() end,     desc = "Git Changed Files" },
    ...
    { "<leader>sb",      function() require("telescope-extensions").find_branch_files() end,     desc = "Find Branch Files" },
    { "<leader>sB",      function() Snacks.picker.lines() end,                                   desc = "Buffer Lines" },
